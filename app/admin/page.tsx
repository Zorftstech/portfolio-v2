...
export default function AdminDashboard() {
  return (
    <section className="space-y-6">
      ...
      <p className="text-sm text-gray-600">Manage site content for the layout and homepage. Authentication is not enforced yet; we can wire Firebase Auth once you confirm your preferred approach.</p>
