...
const AboutUs: React.FC = () => {
  return (
    <div className="mx-auto flex flex-col items-start justify-start lg:py-24 pb-16 my-8 w-full">
      <div className="w-[380px] lg:w-full">
        <div className="">
          <h4 className="text-[14px] leading-[16.1px] text-[#9C9AA1] bg-[#F2F2F2] p-2 rounded-lg w-[78px]">
            About Us
          </h4>
          <h2 className="text-[34px] leading-[45px] md:text-[72px] md:leading-[80px] font-bold text-[#004AAD] mt-5 lg:mt-2">
            Company Overview
          </h2>
        </div>

        <p className="text-[18px] lg:text-[20px] leading-[28px] lg:leading-[34px] text-[#5F5E6C] mt-10 lg:mt-14 md:w-[935px] h-[136px] font-normal">
