...
const AboutUs: React.FC = () => {
  return (
    <div className='mx-auto flex flex-col items-start justify-start max-w-7xl p-24 pb-16 my-8 lg:px-8 w-full'>
      <div>
        <div className=''>
          <h4 className='text-[14px] leading-[16.1px] text-[#9C9AA1] bg-[#F2F2F2] p-2 rounded-lg w-[78px]'>About Us</h4>
