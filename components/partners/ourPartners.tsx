...
const OurPartners: React.FC = () => {
  ...
  return (
    <div className="">
      ...
      <SideWrapper>
        <div className="overflow-x-auto lg:overflow-hidden mt-16 md:mt-28 lg:my-52">
          {partners?.length !== 0 ? (
            <div className="grid grid-cols-4 lg:grid-cols-2 gap-96 md:gap-[800px] lg:gap-20 items-center lg:justify-items-center">
