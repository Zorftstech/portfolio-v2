...
const BenefitOfParnership: React.FC = () => {
  return (
    <div className="mx-auto mt-28 lg:mt-8 mb-20 lg:my-40 w-full">
      {partners.slice(0, 1).map((partner) => (
        <div
          key={partner.id}
          className="grid grid-cols-1 lg:grid-cols-2 lg:gap-x-[97px] gap-y-[50px] lg:gap-y-[97px]"
        >
          <div className="lg:mt-16 w-full lg:w-[610px]">
            ...
            <div className="flex gap-3 justify-around align-center bg-[#E6EDF7] border-[#B0C7E6] w-fit lg:w-[277px] h-[48px] lg:h-[63px] lg:w- mt-10 rounded-full px-3 lg:px-8">
