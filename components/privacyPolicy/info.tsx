      ...
      <div className="w-[90vw] max-w-7xl mx-auto mt-[140px]">
        ...
        <div>
          ...
          <p className="text-[18px] my-3">
            Zorfts Technologies (&quot;us&quot;, &quot;we&quot;, or
            &quot;our&quot;) is committed to protecting the privacy of your
            personal information. This Privacy Policy explains how we collect,
            use, disclose, and safeguard your information when you use our
            services (&quot;Services&quot;) offered through the Zorfts
          ...
          <div className="mt-4">
            ...
            <p className="text-[18px] ml-7">
              ...
              identify you (&quot;Personal Information&quot;). Personal
            ...
            <p className="text-[18px] ml-7">
              ...
              (&quot;Children&quot;): <br /> We do not knowingly collect
              personally identifiable information from children. If you are a
              parent or guardian and you are aware that your child has provided
              us with Personal Information, please contact us. If we become
            ...
            <div className="mb-[10rem]">
              ...
              <li className="text-[18px] ml-7">
                ...
                <Link className=" text-blue-600 ml-4" href={"/contact-us"}>
                  Contact us
                </Link>
              </li>
            </div>
