...
const TestimonialCard: React.FC = () => {
	return (
		<div className="mx-auto max-w-7xl grid lg:grid-cols-3 gap-4 p-24 my-8 lg:px-8">
			{testimonialCards.map((testimonie: TestimonialCards) => (
			<div key={testimonie.id} className="bg-[#F8F8F8] rounded-[26px] w-[400px] h-[fit-content] p-4">
