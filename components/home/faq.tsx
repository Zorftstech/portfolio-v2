    ...
    return (
        <div className='mx-auto max-w-7xl  p-24 lg:px-8 mb-8'>
            <div className='flex justify-center items-center'>
                <h4 className='text-center bg-slate-300 p-2 rounded text-gray-600 w-[60px]'>FAQ</h4>
            </div>
            <h2 className='text-[#004AAD] text-[64px] text-center leading-[74px] font-semibold'>Any Questions?</h2>
            <p className='text-center font-normal leading-7 mt-4'>At Zorft technologies, we make use of modern and efficient technology for our projects.</p>


            {/* ================== faq accordion ==================== */}
            <div className="mx-auto max-w-7xl mt-24">
                {faqs.map((faq) => (
                    <div className="divide-y divide-solid divide-gray-500 w-[100%]" key={faq.id}>
