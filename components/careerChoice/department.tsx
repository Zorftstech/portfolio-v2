    ...
    return (
        <div className="mt-10 lg:mt-32">
            <div key={career.id} className="">
                ...
                <div className="w-[372px] lg:w-[1200px] text-start">
                    <h4 className="text-[24px] lg:text-[28px] leading-[50px] lg:leading-[50px] text-[#3B3B3B] font-bold mb-5">Your Role.</h4>
                    
                    <ol className="list-decimal pl-7">
                        {career.your_role.map((role: YourRole) => (
                            <li key={role.id} className="text-[16px] lg:text-[20px] leading-[27px] lg:leading-[31px] text-[#5F5E6C]">{role.duty}</li>
                        ))}
                    </ol>
                ...
                <div className="w-[372px] lg:w-[1200px] text-start">
                    <h4 className="text-[24px] lg:text-[28px] leading-[50px] lg:leading-[50px] text-[#3B3B3B] font-bold mb-5">Your Skills.</h4>
                    
                    <ol  className="list-decimal pl-7">
                        {career.your_skills.map((skills: YourSkills) => (
                            <li key={skills.id} className="text-[16px] lg:text-[20px] leading-[27px] lg:leading-[31px] text-[#5F5E6C]">{skills.skill}</li>
                        ))}
                    </ol>
